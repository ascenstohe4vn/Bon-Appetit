...
public class CookingPotMenu extends RecipeBookMenu<RecipeWrapper, CookingPotRecipe>
{
    ...
    public CookingPotMenu(final int windowId, final Inventory playerInventory, final CookingPotEntity blockEntity, ContainerData cookingPotDataIn) {
        super(BAMenuTypes.COOKING_POT.get(), windowId);
    ...
    private static CookingPotEntity getTileEntity(final Inventory playerInventory, final FriendlyByteBuf data) {
        Objects.requireNonNull(playerInventory, "playerInventory cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final BlockEntity tileAtPos = playerInventory.player.level().getBlockEntity(data.readBlockPos());
        if (tileAtPos instanceof CookingPotEntity) {
            return (CookingPotEntity) tileAtPos;
        }
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(canInteractWithCallable, playerIn, BABlocks.COOKING_POT.get());
    }
    ...
    public RecipeBookType getRecipeBookType() {
        return RecipeBookType.valueOf("BONAPPETIT_COOKING");
    }
