...
public class CookingPotRecipeBookComponent extends RecipeBookComponent {
    protected static final WidgetSprites RECIPE_BOOK_BUTTONS = new WidgetSprites(
            ResourceLocation.fromNamespaceAndPath(BonAppetit.ID, "recipe_book/cooking_pot_enabled"),
            ResourceLocation.fromNamespaceAndPath(BonAppetit.ID, "recipe_book/cooking_pot_disabled"),
            ResourceLocation.fromNamespaceAndPath(BonAppetit.ID, "recipe_book/cooking_pot_enabled_highlighted"),
            ResourceLocation.fromNamespaceAndPath(BonAppetit.ID, "recipe_book/cooking_pot_disabled_highlighted"));
    ...
    protected Component getRecipeFilterName() {
        return TextHelper.getTranslation("container.recipe_book.cookable");
    }
