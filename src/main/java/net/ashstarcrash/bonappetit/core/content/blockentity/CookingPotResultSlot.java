...
public class CookingPotResultSlot extends SlotItemHandler {
    public final CookingPotEntity tileEntity;
    private final Player player;
    private int removeCount;

    public CookingPotResultSlot(Player player, CookingPotEntity tile, IItemHandler inventoryIn, int index, int xPosition, int yPosition) {
