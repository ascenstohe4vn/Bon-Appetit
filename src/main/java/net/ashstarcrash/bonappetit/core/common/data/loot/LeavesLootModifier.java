package net.ashstarcrash.bonappetit.core.common.data.loot;
...
public class LeavesLootModifier extends LootModifier {
    public static final MapCodec<LeavesLootModifier> CODEC = RecordCodecBuilder.mapCodec(inst ->
    ...
    protected LeavesLootModifier(LootItemCondition[] conditionsIn, Item item, List<LootItemFunction> functions) {
        super(conditionsIn);
        this.item = item;
