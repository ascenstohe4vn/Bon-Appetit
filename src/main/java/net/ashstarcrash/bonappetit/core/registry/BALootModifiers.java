...
public class BALootModifiers {
    public static final DeferredRegister<MapCodec<? extends IGlobalLootModifier>> LOOT_MODIFIER_SERIALIZERS = DeferredRegister.create(NeoForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, "bonappetit");
    ...
    public static final DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<DungeonLootModifier>> DUNGEON_LOOT_MODIFIER =
            LOOT_MODIFIER_SERIALIZERS.register("add_dungeon_item", () -> DungeonLootModifier.CODEC);
    public static final DeferredHolder<MapCodec<? extends IGlobalLootModifier>, MapCodec<AbandonedMineshaftLootModifier>> ABANDONED_MINESHAFT_LOOT_MODIFIER =
            LOOT_MODIFIER_SERIALIZERS.register("add_mineshaft_item", () -> AbandonedMineshaftLootModifier.CODEC);
}
